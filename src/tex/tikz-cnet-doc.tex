...
\begin{stylekey}{/tikz/cnet db storage}
Sets |shape={cnet db storage}|.
\begin{codeexample}[preamble={\usetikzlibrary{shapes.cnet.dbstorage}}]
\tikz{\node[cnet db storage] {};}
\end{codeexample}
\end{stylekey}

\begin{stylekey}{/tikz/cnet envelope}
Sets |shape={cnet envelope}|.
\begin{codeexample}[preamble={\usetikzlibrary{shapes.cnet.envelope}}]
\tikz{\node[cnet envelope] {};}
\end{codeexample}
\end{stylekey}

\begin{stylekey}{/tikz/cnet envelope with at}
Sets |shape={cnet envelope with at}|.
\begin{codeexample}[preamble={\usetikzlibrary{shapes.cnet.envelopewithat}}]
\tikz{\node[cnet envelope with at] {};}
\end{codeexample}
\end{stylekey}

\begin{stylekey}{/tikz/cnet file blank}
Sets |shape={cnet file blank}|.
\begin{codeexample}[preamble={\usetikzlibrary{shapes.cnet.fileblank}}]
\tikz{\node[cnet file blank] {};}
\end{codeexample}
\end{stylekey}
...
\begin{stylekey}{/tikz/cnet institution}
Sets |shape={cnet institution}|.
\begin{codeexample}[preamble={\usetikzlibrary{shapes.cnet.institution}}]
\tikz{\node[cnet institution] {};}
\end{codeexample}
\end{stylekey}
...
\begin{stylekey}{/tikz/cnet man standing}
Sets |shape={cnet man standing}|.
\begin{codeexample}[preamble={\usetikzlibrary{shapes.cnet.manstanding}}]
\tikz{\node[cnet man standing] {};}
\end{codeexample}
\end{stylekey}
...
\begin{stylekey}{/tikz/cnet suited man standing}
Sets |shape={cnet suited man standing}|.
\begin{codeexample}[preamble={\usetikzlibrary{shapes.cnet.suitedmanstanding}}]
\tikz{\node[cnet suited man standing] {};}
\end{codeexample}
\end{stylekey}
